...
public interface CommandeClientApi {
    ...
    @PostMapping(value = COMMANDE_CLIENT_ENDPOINT + "/create", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PatchMapping(value = COMMANDE_CLIENT_ENDPOINT + "/update/etat/{idCommande}/{etatCommande}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PatchMapping(value = COMMANDE_CLIENT_ENDPOINT + "/update/qantite/{idCommande}/{idLigneCommande}/{quantite}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PatchMapping(value = COMMANDE_CLIENT_ENDPOINT + "/update/client/{idCommande}/{idClient}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PatchMapping(value = COMMANDE_CLIENT_ENDPOINT + "/update/article/{idCommande}/{idLigneCommande}/{idArticle}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = COMMANDE_CLIENT_ENDPOINT + "/delete/article/{idCommande}/{idLigneCommande}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = COMMANDE_CLIENT_ENDPOINT + "/find/lignesCommande/{idCommande}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = COMMANDE_CLIENT_ENDPOINT + "/commandeClients/find/id/{idClient}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = COMMANDE_CLIENT_ENDPOINT + "/find/code/{codeClient}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = COMMANDE_CLIENT_ENDPOINT + "/find/all", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = COMMANDE_CLIENT_ENDPOINT + "/delete/{idCommandeClient}")
