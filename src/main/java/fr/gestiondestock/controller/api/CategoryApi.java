...
public interface CategoryApi {
    ...
    @GetMapping(value = CATEGORY_ENDPOINT + "/find/id/{idCategory}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = CATEGORY_ENDPOINT + "/find/code/{codeCategory}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = CATEGORY_ENDPOINT + "/find/all", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = CATEGORY_ENDPOINT + "/delete/id/{idCategory}")
    ...
    ResponseEntity<Void> deleteById(@PathVariable("idCategory") Integer id);
