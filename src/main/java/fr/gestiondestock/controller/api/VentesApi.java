...
public interface VentesApi {
    ...
    @GetMapping(value = VENTES_ENDPOINT + "/find/id/{idVente}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = VENTES_ENDPOINT + "/find/code/{codeVente}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = VENTES_ENDPOINT + "/find/all", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = VENTES_ENDPOINT + "/delete/id/{idVente}")
    ...
    ResponseEntity<Void> deleteById(@PathVariable("idVente") Integer id);
