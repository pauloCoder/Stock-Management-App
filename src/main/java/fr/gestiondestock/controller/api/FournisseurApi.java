...
public interface FournisseurApi {
    ...
    @GetMapping(value = FOURNISSEUR_ENDPOINT + "/find/id/{idFournisseur}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = FOURNISSEUR_ENDPOINT + "find/all", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = FOURNISSEUR_ENDPOINT + "/delete/id/{idFournisseur}")
    ...
    ResponseEntity<Void> deleteById(@PathVariable("idFournisseur") Integer id);
}
