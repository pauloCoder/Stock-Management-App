...
public interface UtilisateurApi {
    ...
    @GetMapping(value = UTILISATEUR_ENDPOINT + "/find/id/{utilisateurId}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = UTILISATEUR_ENDPOINT + "/delete/id/{utilisateurId}")
