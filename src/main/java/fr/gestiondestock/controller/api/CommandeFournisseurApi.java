...
public interface CommandeFournisseurApi {
    ...
    @PatchMapping(value = COMMANDE_FOURNISSEUR_ENDPOINT + "/update/qantite/{idCommande}/{idLigneCommande}/{quantite}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = COMMANDE_FOURNISSEUR_ENDPOINT + "/find/lignesCommande/{idCommande}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = COMMANDE_FOURNISSEUR_ENDPOINT + "/find/id/{idCommandeFournisseur}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = COMMANDE_FOURNISSEUR_ENDPOINT + "/find/code/{codeCommandeFournisseur}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = COMMANDE_FOURNISSEUR_ENDPOINT + "/find/all", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = COMMANDE_FOURNISSEUR_ENDPOINT + "/delete/id/{idCommandeFournisseur}")
