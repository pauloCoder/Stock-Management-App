...
public interface ArticleApi {
    ...
    @GetMapping(value = ARTICLE_ENDPOINT + "/find/id/{idArticle}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = ARTICLE_ENDPOINT + "/find/code/{codeArticle}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = ARTICLE_ENDPOINT + "/historique/vente/id/{idArticle}", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<List<LigneVenteDto>> findHistoriqueVentes(@PathVariable("idArticle") Integer idArticle);

    @GetMapping(value = ARTICLE_ENDPOINT + "/historique/commandeClient/id/{idArticle}", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<List<LigneCommandeClientDto>> findHistoriqueCommandeClient(@PathVariable("idArticle") Integer idArticle);

    @GetMapping(value = ARTICLE_ENDPOINT + "/historique/commandeFournisseur/id/{idArticle}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = ARTICLE_ENDPOINT + "filter/category/id/{idCategory}", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<List<ArticleDto>> findAllArticleByIdCategory(@PathVariable("idCategory") Integer idCategory);

    @GetMapping(value = ARTICLE_ENDPOINT + "/find/all", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = ARTICLE_ENDPOINT + "/delete/id/{idArticle}")
