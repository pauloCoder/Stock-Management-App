...
public interface EntrepriseApi {
    ...
    @GetMapping(value = ENTREPRISE_ENDPOINT + "/{entrepriseId}" , produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = ENTREPRISE_ENDPOINT + "/{entrepriseId}")
    ...
    ResponseEntity deleteById(@PathVariable("entrepriseId") Integer id);
