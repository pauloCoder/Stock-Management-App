...
public class CommandeClientController implements CommandeClientApi {
    ...
    @Override
    public ResponseEntity<List<LigneCommandeClientDto>> findAllLignesCommandesClientByIdCommandeClient(Integer idCommande) {
        return ResponseEntity.ok(commandeClientService.findAllLignesCommandesClientByIdCommandeClient(idCommande));
    }
